...
# Function to convert text to speech for recommendations
...
def run_venue_recommendation_app():
    ...
    if st.button("Get Recommendations"):
        ...
        if venues:
            ...
            # Display venue information and text-to-speech option
            for venue in venues:
                ...
                # Audio output for recommendations
                audio_data = text_to_speech(recommendations)
